...
This directory is the authorecon page on f-keys.com. Nothing in it is
written by hand.
...
All three come from `PAGES["authorecon"]` in `tools/buildsite.py`.
...
[The page itself](https://f-keys.com/authorecon/)
