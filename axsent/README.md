...
This directory is the axsent page on f-keys.com. Nothing in it is
written by hand.
...
All three come from `PAGES["axsent"]` in `tools/buildsite.py`.
...
[The page itself](https://f-keys.com/axsent/)
