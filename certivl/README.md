...
This directory is the certivl page on f-keys.com. Nothing in it is
written by hand.
...
All three come from `PAGES["certivl"]` in `tools/buildsite.py`.
...
[The page itself](https://f-keys.com/certivl/)
