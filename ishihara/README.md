...
This directory is the ishihara page on f-keys.com. Nothing in it is
written by hand.
...
All three come from `PAGES["ishihara"]` in `tools/buildsite.py`.
...
[The page itself](https://f-keys.com/ishihara/)
