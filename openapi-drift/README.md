...
This directory is the openapi-drift page on f-keys.com. Nothing in it is
written by hand.
...
All three come from `PAGES["openapi-drift"]` in `tools/buildsite.py`.
...
[The page itself](https://f-keys.com/openapi-drift/)
