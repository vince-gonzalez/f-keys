...
Canonical: https://f-keys.com/poticas/
...
Potica is a Slovenian rolled nut bread, and this is the reference for it:
where it comes from, how it is actually made, and the short list of people who
still ship one.

## The list is short for a reason

It is a slow bread with a thin dough and a filling heavy enough to tear it,
