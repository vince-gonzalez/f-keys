...
<p class="sub">Four command-line tools, six packages, and thirty-five JSON
documents. Everything here is a thing you install or a file you fetch, and
there is nothing to sign up for.</p>

<h2>Start here</h2>
<table class="facts">
<tr><th>OpenAPI</th><td><a href="/openapi.json">/openapi.json</a> &mdash; all 35
documents, each with a typed schema naming its columns</td></tr>
...
<p>Thirty-five JSON documents, every one described in
